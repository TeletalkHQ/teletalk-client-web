export const stuff = {
  errors: [
    ...
    { isAuthError: true, side: "CLIENT", reason: "CLIENT_COOKIE_REQUIRED" },
    {
      isAuthError: false,
      side: "CLIENT",
      reason: "CLIENT_ID_CAN_NOT_VERIFIED",
    },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_INVALID" },
    { isAuthError: true, side: "CLIENT", reason: "CLIENT_NOT_FOUND" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_NOT_VERIFIED" },
    { isAuthError: false, side: "CLIENT", reason: "CONTACT_ITEM_EXIST" },
    { isAuthError: false, side: "CLIENT", reason: "CONTACT_ITEM_NOT_EXIST" },
    { isAuthError: false, side: "CLIENT", reason: "COOKIE_IS_NOT_DEFINED" },
    {
      isAuthError: false,
      side: "CLIENT",
    ...
    { isAuthError: false, side: "CLIENT", reason: "CURRENT_CLIENT_NOT_EXIST" },
    { isAuthError: false, side: "CLIENT", reason: "CURRENT_USER_EXIST" },
    { isAuthError: false, side: "CLIENT", reason: "CURRENT_USER_NOT_EXIST" },
