export const stuff = {
  errors: [
    ...
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_ID_TYPE_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_ID_EMPTY_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_ID_REQUIRED_ERROR" },
    {
      isAuthError: false,
      side: "CLIENT",
      reason: "CLIENT_ID_MIN_LENGTH_ERROR",
    },
    {
      isAuthError: false,
      side: "CLIENT",
      reason: "CLIENT_ID_MAX_LENGTH_ERROR",
    },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_ID_UNIQUE_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENT_ID_INVALID" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENTS_TYPE_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENTS_REQUIRED_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENTS_EMPTY_ERROR" },
    { isAuthError: false, side: "CLIENT", reason: "CLIENTS_INVALID" },
    ...
    { isAuthError: true, side: "CLIENT", reason: "CLIENT_NOT_VERIFIED" },
    ...
    { isAuthError: true, side: "CLIENT", reason: "CURRENT_CLIENT_NOT_EXIST" },
    ...
    { isAuthError: false, side: "CLIENT", reason: "SELF_STUFF" },
    {
      isAuthError: false,
      side: "SERVER",
  ...
  models: {
    ...
    clients: { type: "array", required: true, empty: true },
        ...
        user: {
          ...
          value: {
            ...
            clients: {
              required: true,
              type: "array",
              value: [{ clientId: { required: true, type: "string" } }],
            },
          },
        },
      },
  ...
  validationModels: {
    ...
    clientId: {
      messages: {
        stringEmpty: "CLIENT_ID_EMPTY_ERROR",
        stringMax: "CLIENT_ID_MAX_LENGTH_ERROR",
        stringMin: "CLIENT_ID_MIN_LENGTH_ERROR",
        required: "CLIENT_ID_REQUIRED_ERROR",
        string: "CLIENT_ID_TYPE_ERROR",
    ...
    clients: {
      messages: {
        stringEmpty: "CLIENTS_EMPTY_ERROR",
        required: "CLIENTS_REQUIRED_ERROR",
        string: "CLIENTS_TYPE_ERROR",
      },
      empty: true,
      required: true,
      type: "array",
